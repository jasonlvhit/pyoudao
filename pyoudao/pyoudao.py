...
def get_parser():
	parser = argparse.ArgumentParser(description='Tiny command line tool for youdao translation.')  
	parser.add_argument('-o', '--online', type=str, nargs='*',help='online translation')
	parser.add_argument('-l', '--local', type=str, nargs='*', help='offline translation, for a given english word, return the chinese meaning')
	return parser
